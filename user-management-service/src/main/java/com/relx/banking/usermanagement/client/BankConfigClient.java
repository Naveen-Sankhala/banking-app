package com.relx.banking.usermanagement.client;
...
import com.relx.banking.usermanagement.config.ConfigListener;
import com.relx.banking.usermanagement.util.UserManagmentUtil;
...
public class BankConfigClient {
	...
	public MasCurrencyDto getMasCurrency(String curCode ,Long countryId) {
		...
		List<MasCurrencyDto> list = UserManagmentUtil.getMapObjectValue("MasCurrency", obj, MasCurrencyDto.class);
	...
	public GenderTitleDto getMasGenderTitle(String genderCode) {
		...
		List<GenderTitleDto> list = UserManagmentUtil.getMapObjectValue("MasGenderTitle", obj, GenderTitleDto.class);
	...
	public RelationDto getMasRelation(String relationCode) {
		...
		List<RelationDto> list = UserManagmentUtil.getMapObjectValue("MasRelation", obj, RelationDto.class);
	...
	public OccupationDto getMasOccupation(String ocpName) {
		Object obj = listener.getConfig("MasRelation");
		List<OccupationDto> list = UserManagmentUtil.getMapObjectValue("MasOccupation", obj, OccupationDto.class);
	...
	public ReligionDto getMasReligion(String rlgnCode) {
		...
		List<ReligionDto> list = UserManagmentUtil.getMapObjectValue("MasReligion", obj, ReligionDto.class);
	...
	public CastDto getMasCast(String castCode) {
		...
		List<CastDto> list = UserManagmentUtil.getMapObjectValue("MasCast", obj, CastDto.class);
	...
	public CustomerConstitutionDto getMasCustomerConst(String conCode) {
		...
		List<CustomerConstitutionDto> list = UserManagmentUtil.getMapObjectValue("MasCustomerConst", obj, CustomerConstitutionDto.class);
