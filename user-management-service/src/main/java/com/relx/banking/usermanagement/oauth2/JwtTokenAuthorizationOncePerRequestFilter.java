package com.relx.banking.usermanagement.oauth2;
...
public class JwtTokenAuthorizationOncePerRequestFilter extends OncePerRequestFilter{
    ...
    private final IUserManagmentService iUserManagmentService;
    
	@Override
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
			throws ServletException, IOException {

		System.out.println("Authentication Request For Header '{}'"+ request);
		...
		if(reqURI.contains("/config/common/") ) { 
			...
			if (requestTokenHeader != null && requestTokenHeader.startsWith(BEARER_PREFIX)) {
				...
				throw new AuthenticationException("JWT_TOKEN_DOES_NOT_START_WITH_BEARER_STRING");
			}
			...
			if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
    			...
    			HashMap<String, Object> validMap = iUserManagmentService.getAuthority(claimsData.getUserId(), claimsData.getBranchId());
