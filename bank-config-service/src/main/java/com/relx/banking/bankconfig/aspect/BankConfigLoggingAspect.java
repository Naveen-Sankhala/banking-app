package com.relx.banking.bankconfig.aspect;
...
@Component
@Slf4j
public class BankConfigLoggingAspect {

	@Pointcut("execution(* com.relx.banking.bankconfig.controller.*.*(..))")
	private void forControllerPackage() {}

	@Pointcut("execution(* com.relx.banking.bankconfig.service.*.*(..))")
